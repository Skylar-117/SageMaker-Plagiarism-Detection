...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=3, metavar='IN', help='dimension (number of features) (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=20, metavar='H', help='hidden layer dimension(default: 20)')
